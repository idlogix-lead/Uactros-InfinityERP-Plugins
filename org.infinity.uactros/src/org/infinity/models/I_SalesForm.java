...
public interface I_SalesForm 
{
    ...
    /** TableName=SalesForm */
    public static final String Table_Name = "SalesForm";
    ...
    public static final String COLUMNNAME_Registration_No = "Registration_No";
    ...
    /** Column name SalesForm_UU */
    public static final String COLUMNNAME_SalesForm_UU = "SalesForm_UU";
    ...
    /** Column name ViewLedger */
    public static final String COLUMNNAME_ViewLedger = "ViewLedger";

	/** Set View Ledger.
	  * View Ledger of the Party
	  */
